                      ...
                      {attendanceHistoryEntries.length > 0 ? (
                        <div className="employee-attendance-history-table" role="table" aria-label="Attendance history">
                          ...
                          {attendanceHistoryEntries.map((entry, index) => {
                            ...
                            return (
                              <div key={entry.id ?? `${entry.time_in_at ?? entry.time_out_at ?? "history"}-${index}`} className="employee-attendance-history-row" role="row">
                                ...
                                <span role="cell" className="attendance-tag-cell">
                                  ...
                                  <button type="button" className="btn attendance-tag-edit-button" onClick={() => openAttendanceEditModal(entry)}>Edit</button>
                                </span>
                              </div>
                            );
                          })}
